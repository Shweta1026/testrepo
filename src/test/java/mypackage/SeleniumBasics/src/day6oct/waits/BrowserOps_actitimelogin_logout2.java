...
/*
 * TC1: Actitime Open browser enter application url clear text from username
 * type username as Admin clear text form password type password as admin click
 * on login button validation vtiger home page either with title or url logout
 * from the application validation vtiger login page
 */
